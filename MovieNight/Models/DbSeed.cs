    ...
    public static class DbSeed
    {
        ...
        public async static Task SeedMovies()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // http://omdbapi.com/?apikey=ccd5c7b0&i=tt0012348
                client.BaseAddress = new Uri("http://www.omdbapi.com/");

                foreach (string imdbId in ImdMovieIds())
                {
                    var result = await client.GetAsync("?apikey=ccd5c7b0&i=" + imdbId);
        ...
        public static string[] ImdMovieIds()
        {
